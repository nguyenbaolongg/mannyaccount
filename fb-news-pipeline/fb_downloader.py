...
def download_video(video_url: str, video_id: str) -> dict | None:
    ...
    # Fallback: Playwright
    print("   ↳ yt-dlp thất bại, thử Playwright...")
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            def handle_response(response):
                ...
                if ("video/" in ct or ".mp4" in url) and "thumbnail" not in url and "preview" not in url:
            ...
            resp = requests.get(video_direct_url["url"], timeout=300, stream=True,
